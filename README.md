...
当前稳定版本是 `v0.4.0`，当前开发分支是 `codex/v0.5.0`。
...
当前会优先把本地审校器接起来，再考虑更深的自动改写和批量 review。
...
- `v0.2.0`：GUI 骨架、本地项目初始化器、基础目录结构，已完成并发布
- `v0.3.0`：总纲/卷纲/剧情单元/伏笔账本生成强化，已完成并发布
- `v0.4.0`：章节卡生成与进度推进，已完成并发布
- `v0.5.0`：本地审校器与一致性检查
